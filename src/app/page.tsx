  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <div style={{ marginBottom: 20 }}>
        <Select value={library} onChange={setLibrary}>
        ...
        <Slider min={10} max={30} value={fontSize} onChange={setFontSize} />
      </div>

      {library === "chartjs" && <ChartJSComponent primaryColor={primaryColor} fontFamily={fontFamily} fontSize={fontSize} />}
      {library === "nivo" && <NivoComponent primaryColor={primaryColor} fontFamily={fontFamily} fontSize={fontSize} />}
      {library === "plotly" && <PlotlyComponent primaryColor={primaryColor} fontFamily={fontFamily} fontSize={fontSize} />}
    </div>
  );
}